...
@Component({
  selector: 'app-featuresv6',
  templateUrl: './featuresv6.component.html',
  styleUrls: ['./featuresv6.component.css']
})
export class Featuresv6Component {
  ...
  @Input() feature6ButtonText: string = ' ';
